...
class SubcategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subcategory" do
    assert_difference('Subcategory.count') do
      post subcategories_url, params: { subcategory: { image: @subcategory.image, name: @subcategory.name, section_id: @subcategory.section_id } }
    end
  ...
  test "should update subcategory" do
    patch subcategory_url(@subcategory), params: { subcategory: { image: @subcategory.image, name: @subcategory.name, section_id: @subcategory.section_id } }
